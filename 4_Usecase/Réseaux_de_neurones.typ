...
Heureusement, il existe plusieurs solution syntaxique qui nous permettent de facilité la lecture d'un tel réseau. Ces solutions ne font pas directement partie du noyaux du projet mais permettrait une implémentation plus concrète du typage de réseaux. Vous pourrez voir le @autre la notion d'appel de fonction uniforme qui nous permettrai d'avoir une représentation plus lisible à l'oeil humain à l'aide de tuyaux:
