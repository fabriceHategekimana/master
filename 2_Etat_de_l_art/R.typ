...
Les arrays dans R sont la structure de données la plus proche de ce qu'est un tenseur. En effet, ce sont une représentation de tenseur. En réalité, les arrays sont des vecteurs avec un attribut spécial décrivant la dimension du dit tenseur. Mais la structrure sous-jacente reste le vecteurs.
...
Nous avons aussi des fonctions comme reduce et filter commes pour un langage de programmation fonctionnel utilisant des fonctions d'ordre supérieur.
